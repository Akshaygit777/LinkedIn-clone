...
const News = () => {
  return (
    <div className='hidden md:block w-[25%] bg-[#161722] h-fit rounded-lg border border-gray-800 text-white'>
      ...
      <div>
{
  newsItems.map((item, index)=>{
    return (
      <div key={index} className='px-3 py-2 hover:bg-gray-800 hover:cursor-pointer'>
